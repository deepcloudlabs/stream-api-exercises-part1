...
public class Exercise15 {
    ...
    public static void main(String[] args) {
        // Group the countries by continent and then sort the countries in each continent by the number of cities in each country.
        var countriesByContinent =
                countryDao.findAllCountries()
                        .stream()
                        .sorted(comparingInt(compareByCityNumber).reversed())
